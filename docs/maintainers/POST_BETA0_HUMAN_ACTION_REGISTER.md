...
| Real participant sessions | Human product/research owner | open | `docs/POST_BETA0_HUMAN_ACTION_REGISTER.md` | non-blocking-for-cp0 | ❌ permanently (E5 — an AI persona is not a participant) | Schedule real participant validation sessions after technical closure. Automation cannot substitute for participant feedback. Owner's call formally recorded 2026-07-27 (D5, `docs/DECISION_BRIEFS_2026-07.md`): permanently open with this honest label, not scheduled sessions or an AI-persona substitute, until there is a live product and real users to invite. |
