...
>
> **Map:** `EXECUTION_TREES.md` (moved outside the repo by md-zero-2026-08-11 PLAN.md Phase 2; git
> history keeps it). This document is the executable detail.
>
...
> reachable UI) instead of depth. The consolidated core workstream is `EXECUTION_TREES.md §0.1`
> (moved outside the repo by md-zero-2026-08-11 PLAN.md Phase 2; git history keeps it).
...
*Map: `EXECUTION_TREES.md` · Ledger: `NPDEV_OPEN_ITEMS_REGISTER.md` (both moved outside the repo by
md-zero-2026-08-11 PLAN.md Phase 2; git history keeps them) ·
