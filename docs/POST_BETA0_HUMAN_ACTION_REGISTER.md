...
| Independent audit sign-off | Human owner / independent reviewer | open | `scripts/reports/out/maturity-max-roadmap-boundary-report.json` | non-blocking-for-cp0 | ⚠️ AI does the **review** (E4, mission M6); the **sign-off** stays the owner's | Arrange review outside Codex/Cursor. Automation can register the need but cannot perform independent sign-off. |
