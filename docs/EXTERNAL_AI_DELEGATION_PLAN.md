...
| P9 — Ledgers | **DONE** | This promotion; `docs/OPEN_GAPS_AND_ROADMAP.md` ADR-0009 row; `docs/POST_BETA0_HUMAN_ACTION_REGISTER.md` AI-delegable column; `knowledge/cards/recipe-external-ai-review-feature.json`; `docs/NPDEV_OPEN_ITEMS_REGISTER.md`'s REG-48–52 section; `docs/REG48_50_CLOSURE_PLAN.md` (the follow-up closure plan, also DONE) |
...
the plan's own "P0–P5 now, P6–P7 later" recommendation. **D3 was answered 2026-07-27** (see §7);
D4 and D5 remain open — see `docs/adr/ADR-0009-external-ai-delegation.md`'s decision block.
