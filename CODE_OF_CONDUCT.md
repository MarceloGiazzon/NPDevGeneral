...
reported the same way a security vulnerability is: **do not open a public
issue.** Use GitHub's private reporting instead — go to this repository's
**Security** tab → **Report a vulnerability** — or contact a maintainer
directly through GitHub. See `SECURITY.md` for the same channel's disclosure
process. All complaints will be reviewed and investigated promptly and fairly.
