...
public class GeneratedArtifactPreviewRequest {
    ...
    public GeneratedArtifactPreviewRequest() {
    }

    public String getPreviewReference() {
        return previewReference;
    }

    public void setPreviewReference(String previewReference) {
