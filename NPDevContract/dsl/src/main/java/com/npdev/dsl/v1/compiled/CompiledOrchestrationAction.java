...
public final class CompiledOrchestrationAction {
    ...
    public CompiledOrchestrationAction(String type, String concept, Map<String, String> map) {
        this(type, concept, null, null, null, null, map, null);
    }

    public CompiledOrchestrationAction(
            String type,
            String concept,
            String capability,
            String operation,
