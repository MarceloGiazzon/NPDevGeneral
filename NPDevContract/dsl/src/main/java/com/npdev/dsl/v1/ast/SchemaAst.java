...
public final class SchemaAst {
    ...
    private final Map<String, SchemaAst> properties;
    private final SchemaAst items;
    ...
    public SchemaAst(
            String type,
            Map<String, SchemaAst> properties,
    ...
    public Map<String, SchemaAst> getProperties() {
        return properties;
    }

    public SchemaAst getItems() {
        return items;
    }
