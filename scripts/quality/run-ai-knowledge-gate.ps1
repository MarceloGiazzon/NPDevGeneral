...
try {
    ...
    # [43/43] R3 (MASTER-ROADMAP.md Step 9 / ledger QUAL-6): the coverage ratchet. Static by
    ...
    Write-Host "[43/43] Checking JaCoCo coverage hasn't dropped below its recorded floor..."
