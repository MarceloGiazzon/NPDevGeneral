...
$orderedGates = @(
    ...
    [pscustomobject]@{ name = "trusted-source-beta0-proof-tests"; command = "scripts/quality/run-untrusted-extension-beta0-proof-tests.ps1" },
    [pscustomobject]@{ name = "trusted-source-beta0-proof"; command = "scripts/quality/run-untrusted-extension-beta0-proof.ps1" },
